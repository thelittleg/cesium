...
define([
    ...
    defineProperties(CylinderGraphics.prototype, {
        ...
        /**
         * Gets or sets the {@link VerticalOrigin} {@link Property} specifying the Cylinder's vertical origin.
         * @memberof CylinderGraphics.prototype
         * @type {Property}
         */
        ...
        /**
         * Gets or sets the offset {@link Property} specifying the Cylinder's offset.
         * @memberof CylinderGraphics.prototype
         * @type {Property}
         */
    ...
    CylinderGraphics.prototype.merge = function(source) {
        ...
        this.offset = defaultValue(this.offset, source.offset);
    };
